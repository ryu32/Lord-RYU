...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/ryu32/Lord-ryu.git")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Lord-RYU")

# Bot version
BOT_VER = os.environ.get("BOT_VER", "6.9")
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "``` 🎮Lord-RYU Telah Online kawan🎮 ```")
    return
