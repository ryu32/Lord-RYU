...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(
            f"**Berhasil Menambahkan Sticker Ke Pack, Tekan** **[Lord Sticker](t.me/addstickers/{packname})** **Untuk Melihat Sticker Curian Anda xixixixi**",
            parse_mode="md",
        )
